  ...
  const projects = [
    {
      ...
      description: 'Led the development of a comprehensive library services application, implementing key features and resolving critical issues. Utilized Angular and .NET to create a robust and user-friendly interface for managing library resources and services.',
    ...
    },
    {
      ...
      description: 'Developed and enhanced a generative AI chat application, focusing on UI improvements and bug resolution. Worked directly with clients to ensure project requirements were met and implemented effectively.',
    ...
    },
    {
      ...
      description: 'Contributed to various internal initiatives including Bootstrap development and GitHub Copilot analysis. Created tools and workflows to improve development efficiency and team productivity.',
